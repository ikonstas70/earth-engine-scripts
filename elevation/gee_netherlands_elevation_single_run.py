...
# Define the region of interest (ROI) - Coordinates for a part of the Netherlands
...
def get_elevation_statistics():
    ...
    print("=== Elevation Statistics for the Selected Region ===\n")

    # Region information
    print("Region Coordinates: ")
    print(f"- Latitude: 51.5° N to 52.0° N")
    print(f"- Longitude: 5.5° E to 6.0° E")
    print(f"- **This region is located in the Netherlands**.\n")
